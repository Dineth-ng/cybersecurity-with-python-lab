...
### Networking & Security
- **Networking with Python** - Sockets, Scapy, packet manipulation
- **Port Scanners & Network Tools** - Network reconnaissance and analysis
- **Web Security Testing Automation** - Vulnerability scanning, automated testing
...
├── fundamentals/              # Python basics and OOP
├── networking/                # Socket programming and network tools
├── port-scanners/            # Network scanning tools
├── web-security/             # Web security automation
├── cryptography/             # Encryption and hashing
├── log-analysis/             # Security log parsing and analysis
├── projects/                 # Integrated security projects
